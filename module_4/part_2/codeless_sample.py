...
class TestRegistration():
  ...
  def test_registration(self):
    ...
    self.driver.set_window_size(1654, 978)
    self.driver.find_element(By.ID, "login_link").click()
    self.driver.find_element(By.ID, "id_registration-email").click()
    self.driver.find_element(By.ID, "id_registration-email").send_keys("alukarddemon0@bk.com")
    self.driver.find_element(By.ID, "id_registration-password1").send_keys("A1234567890A")
    self.driver.find_element(By.ID, "id_registration-password2").click()
    self.driver.find_element(By.ID, "id_registration-password2").send_keys("A1234567890A")
